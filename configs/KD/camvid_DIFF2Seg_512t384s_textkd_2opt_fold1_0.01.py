...
optimizer = dict(
    ...
    paramwise_cfg=dict(
        custom_keys={
            'text_kd.student_projection': dict(lr_mult=10.0),
            'text_kd.teacher_projection': dict(lr_mult=10.0),
...
# 작업 디렉토리
work_dir = './work_dirs/kd/textkd_2opt_0.01_imgonly_pre_student/fold1'
