...
parser.add_argument('--only', choices=['fold1', 'fold2', 'both'], default='both')
args = parser.parse_args()

if args.only != 'both':
    target = 'fold1' if args.only == 'fold1' else 'fold2'
    fold_configs = [fc for fc in fold_configs if fc['train_fold'] == target]
...
# 각 fold 평가
# fold_configs = [fold_configs[0]] ####fold 1만. 수정
